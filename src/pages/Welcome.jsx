...
export default function Welcome() {
  return (
    <div className="p-8 pt-20 md:p-20 md:pt-32 flex flex-col items-center justify-center" initial={{opacity: 0, y: 10}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
